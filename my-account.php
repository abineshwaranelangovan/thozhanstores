		...
		<div class="content-blog content-account">
			...
			<div class="row">
				<div class="col-md-6">
					...
					<?php
		$csql = "SELECT u1.firstname, u1.lastname, u1.address1, u1.address2, u1.city, u1.state,  u1.company, u.email, u1.mobile, u1.zip FROM users u JOIN usersmeta u1 ON u.id=u1.uid WHERE u.id=$uid";
